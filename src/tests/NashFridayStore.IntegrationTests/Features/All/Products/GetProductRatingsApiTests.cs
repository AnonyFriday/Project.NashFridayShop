...
using NashFridayStore.API.Features.All.Products.GetProductRatings;
...
public class GetProductRatingsApiTests : IClassFixture<CustomWebApplicationFactory>, IDisposable
{
    ...
    public async Task GetProductRatings_WithRatings_ShouldReturnCorrectData()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products/{product.Id}/ratings", cancellationToken);
    ...
    public async Task GetProductRatings_WithPagination_ShouldReturnCorrectPage()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products/{product.Id}/ratings?pageIndex=1&pageSize=2", cancellationToken);
    ...
    public async Task GetProductRatings_ProductNotFound_ShouldReturn404()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products/{nonExistentProductId}/ratings", cancellationToken);
    ...
    public async Task GetProductRatings_InvalidPageSize_ShouldReturnValidationError()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products/{product.Id}/ratings?pageSize=150", cancellationToken);
