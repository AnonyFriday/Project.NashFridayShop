...
public class GetProductsApiTests : IClassFixture<CustomWebApplicationFactory>, IDisposable
{
    ...
    public async Task GetProducts_SearchName_ShouldFilterCorrectly()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/products?searchName=Lap", cancellationToken);
        ...
        Assert.Equal("Laptop", result.Items[0].Name);
    }
    ...
    public async Task GetProducts_SearchName_NoMatch_ShouldReturnEmpty()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/products?searchName=Phone", cancellationToken);
    ...
    public async Task GetProducts_CategoryId_ShouldFilterCorrectly()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products?categoryId={cat1.Id}", cancellationToken);
    ...
    public async Task GetProducts_CategoryId_NoMatch_ShouldReturnEmpty()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products?categoryId={Guid.NewGuid()}", cancellationToken);
    ...
    public async Task GetProducts_PriceRange_ShouldFilterCorrectly()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/products?minPrice=50&MaxPrice=150", cancellationToken);
        ...
        Assert.NotNull(result);
        Assert.Single(result.Items);
        Assert.Equal(100, result.Items[0].PriceUsd);
    }
    ...
    public async Task GetProducts_MinPriceOnly_ShouldFilterCorrectly()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/products?minPrice=50", cancellationToken);
    ...
    public async Task GetProducts_ShouldExcludeDeletedProducts()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/products", cancellationToken);
    ...
    public async Task GetProducts_Status_ShouldFilterCorrectly()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync($"/api/all/products?status=InStock", cancellationToken);
        ...
        Assert.NotNull(result);
        Assert.Single(result.Items);
        Assert.Equal(ProductStatus.InStock, result.Items[0].Status);
    }
    ...
    public async Task GetProducts_WithRatings_ShouldReturnCorrectAverageStars()
    {
        ...
        ProductItem laptopItem = result.Items.First(p => p.Name == "Laptop");
        ProductItem mouseItem = result.Items.First(p => p.Name == "Mouse");
    ...
    public async Task GetProducts_NoRatings_ShouldReturnZeroAverageStars()
    {
        ...
        Assert.NotNull(result);
        Assert.Single(result.Items);
        Assert.Equal(0.0m, result.Items[0].AverageStars);
    }
    ...
    public async Task GetProducts_WithDeletedRatings_ShouldExcludeDeletedRatingsFromAverage()
    {
        ...
        Assert.NotNull(result);
        Assert.Single(result.Items);
        Assert.Equal(5.0m, result.Items[0].AverageStars); // Only the active rating (5) is counted
    }
    #endregion
}
