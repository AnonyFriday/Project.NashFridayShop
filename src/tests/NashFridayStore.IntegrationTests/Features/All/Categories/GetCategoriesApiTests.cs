...
using NashFridayStore.API.Features.All.Categories.GetCategories;

namespace NashFridayStore.IntegrationTests.Features.All.Categories;
...
public class GetCategoriesApiTests : IClassFixture<CustomWebApplicationFactory>, IDisposable
{
    ...
    public async Task GetCategories_ShouldReturnCategories()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/categories", cancellationToken);
    ...
    public async Task GetCategories_WithSearchName_ShouldReturnFilteredCategories()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/categories?searchName=Book", cancellationToken);
    ...
    public async Task GetCategories_WithPagination_ShouldReturnPagedCategories()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/categories?pageSize=2&pageIndex=1", cancellationToken);
    ...
    public async Task GetCategories_WithIsAllTrue_ShouldReturnAllCategoriesWithoutPagination()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/categories?isAll=true", cancellationToken);
    ...
    public async Task GetCategories_WithIsAllTrueAndSearchName_ShouldReturnFilteredCategoriesWithoutPagination()
    {
        ...
        // Act
        HttpResponseMessage response = await _client.GetAsync("/api/all/categories?isAll=true&searchName=Book", cancellationToken);
